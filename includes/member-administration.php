...
<div class="member-administration">
	...
	<div class="tab-content">
				...
				<table class="table searchablePending">
					...
					<tbody>
						...
						<?php foreach($postsPending as $post): setup_postdata($post); ?>
							...
							<div id="pendingModalApply<?php the_id(); ?>" class="modal fade" role="dialog">
							    <div class="modal-dialog modal-lg">
							        <div class="modal-content">
							            <div class="modal-header">
							                <a href="<?php echo $adminURL; ?>" type="button" class="close">&times;</a>
		...
		<div role="tabpanel" class="tab-pane manual" id="manual">
...
<?php } ?>
<?php if (false !== strpos($url,'?redirectTwo=' )) { ?>
	<?php
    	$redirectTwo = $_GET['redirectTwo'];
	?>
	<script>
		$("#pendingModalApply<?php echo $redirectTwo; ?>").modal("show")
	</script>
<?php } ?>
